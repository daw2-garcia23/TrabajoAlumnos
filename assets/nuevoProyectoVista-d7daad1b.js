import { U as User } from "./main-dd68d2c9.js";
import { P as Proyecto } from "./proyecto-91fc52f5.js";
const nuevoProyectoVista = {
  ...
  <div class="col-12">
      ...
      <form id="form_proyecto" class="p-3" novalidate>
          <label class="mt-3 form-label text-white" for="nombre">Nombre: </label>
          ...
          <label class="mt-3 form-label text-white" for="descripcion">Descripción: </label>
          ...
          <label class="mt-3 form-label  text-white" for="enlace">Enlace a producción</label>
